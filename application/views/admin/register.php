                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="post" action="<?php echo base_url("admin/Auth_admin/register") ?>">
                                <div class="form-group">
                                    <input type="name" class="form-control form-control-user" id="name" name="name" placeholder="Name">
                                    <?= form_error('name', ' <span class="text-danger ml-3">', '</span>') ?>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="text-center">
                                    <a class="small" href="<?php echo base_url('admin/Auth_admin/login') ?>">Kembali ke Menu Login!</a>
                                </div>
